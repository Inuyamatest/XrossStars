...
(function (root, factory) {
  ...
  var IMPLEMENTATION_EVENTS = {
    ...
    PP_RECOVERED: 'PP_RECOVERED', // カード効果でPPを回復した（amount: 実際に回復した数）
    ...
    CARD_DISCARDED_BY_EFFECT: 'CARD_DISCARDED_BY_EFFECT', // カード効果（DISCARD_HAND）による手札破棄。8章の手札上限処理とは別イベント
    ...
    LEADER_REVIVED: 'LEADER_REVIVED', // ダウンしたリーダーをダウンしていない状態に戻した（復活ポータル）
    TACTICS_RETURNED_TO_AREA: 'TACTICS_RETURNED_TO_AREA', // トラッシュに置く代わりにタクティクスエリアへ戻した（追加マガジン）
